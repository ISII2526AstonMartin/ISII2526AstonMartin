...
namespace AppForSEII2526.API.DTOs.BocadillosParaPedirDTOs
{
    public class CreatePedidoDTO
    {
        ...
        public CreatePedidoDTO(string nombre, MetodoPago metododepago, string apellido1, string apellido2)
        {
            Nombre = nombre;
        ...
        {
            return HashCode.Combine(Nombre, MetodoPago, Apellido1, Apellido2);
        }
    }
}
