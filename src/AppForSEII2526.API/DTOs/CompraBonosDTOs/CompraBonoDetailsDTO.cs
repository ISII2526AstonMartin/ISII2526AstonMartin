namespace AppForSEII2526.API.DTOs.CompraBonosDTOs
{
    public class CompraBonoDetailsDTO : CompraBonoForCreateDTO
    {
        ...
        public CompraBonoDetailsDTO(int Id, DateTime fecha, string nombreCliente, string apellido1, string? apellido2, MetodoPago metodoPago, List<CompraBonoItemDTO> compraItems) 
